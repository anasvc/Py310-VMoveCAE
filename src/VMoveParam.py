...
RegEx = type(
    'RegEx', (), {
        p._name_: re.compile(p._value_)
        for p in [
            Pattern.SECTION_PREFIX, Pattern.DATA_PREFIX,
            Pattern.CONTINUATION_PREFIX, Pattern.COMMENT_PREFIX,
            Pattern.NAME, Pattern.KEY, Pattern.VALUE, Pattern.ATTRIBUTE,
            Pattern.NAME_ATTRIBUTE, Pattern.SUB_ATTRIBUTES, Pattern.PROPERTY,
            Pattern.SECTION, Pattern.DATA,
            Pattern.CONTINUATION, Pattern.COMMENT,
        ]
    })

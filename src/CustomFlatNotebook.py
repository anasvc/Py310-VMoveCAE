...
class FNBRendererDefault(FNBRenderer):
    ...
    def DrawTab(self, pageContainer, dc, posx, tabIdx, tabWidth, tabHeight, btnStatus):
        ...
        if not pc.GetEnabled(tabIdx):                
            # Set the text background to be like the vertical lines
            dc.SetTextForeground(pc._pParent.GetDisabledTabTextColour())

        elif tabIdx != pc.GetSelection():
...
class FlatNotebook(wx.PyPanel):
    ...
    def SetDisabledTabColour(self, color):
        """ Sets the disabled tab colour. """

        self._pages._disabledTabColor = color


    def GetDisabledTabColour(self):
        """ Get the disabled tab text colour. """

        return self._pages._disabledTabColor


    def SetDisabledTabTextColour(self, textColour):
        """ Sets the text colour for the disabled tabs. """

        self._pages._disabledTextColor = textColour


    def GetDisabledTabTextColour(self):
        """ Get the disabled tab text colour. """

        return self._pages._disabledTextColor
...
class PageContainer(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        self._disabledTabColor = wx.WHITE
        self._disabledTextColor  = wx.SystemSettings_GetColour(wx.SYS_COLOUR_BTNTEXT)

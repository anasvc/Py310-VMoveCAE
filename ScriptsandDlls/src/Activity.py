# Refer https://wxpython.org/Phoenix/docs/html/wx.EventFilter.html
#
...
class LastActivityTimeDetector(wx.EventFilter):
    ...
    def FilterEvent(self, event):
        ...
        if (t == wx.EVT_KEY_DOWN.typeId or
                t == wx.EVT_MOTION.typeId or
                t == wx.EVT_LEFT_DOWN.typeId or
                t == wx.EVT_RIGHT_DOWN.typeId or
    ...
    def IsInactiveFor(self, diff):
        return wx.DateTime.Now() - diff > self.last_activity_time
